      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-slate-600 mt-2 text-sm">
            Send us your inquiry or sample denial details. We will analyze the root cause and deliver a recovery report within 12 hours and immediately if contacted through WhatsApp down bellow.
          </p>
        </div>
